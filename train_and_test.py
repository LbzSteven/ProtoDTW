...
def _train_or_test(model, dataloader, optimizer=None, class_specific=True, use_l1_mask=True,
            ...
            if class_specific:
                max_dist = (model.module.prototype_shape[1]
                            * model.module.prototype_shape[2]
                            )  # The prototype shape has one less dimension
    ...
    log('\tavg separation:\t{0}'.format(total_loss))
    ...
    return accu, duration, cross_ent, cluster_cost, separation, avg_separation, total_loss, l1, p_dist_pair
